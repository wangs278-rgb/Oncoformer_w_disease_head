#!/bin/bash
#SBATCH -J onco_mlm
#SBATCH -o /cv/home/wangs278/scratch/fmi/run4_out/logs/train_%J.stdout
#SBATCH -e /cv/home/wangs278/scratch/fmi/run4_out/logs/train_%J.stderr
...
SCRIPT=/cv/home/wangs278/scratch/fmi/train.py
