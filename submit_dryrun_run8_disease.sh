#!/bin/bash
#SBATCH -J onco_dry_run8
#SBATCH -o /cv/home/wangs278/scratch/fmi/run8_disease_out/logs/dryrun_%J.stdout
#SBATCH -e /cv/home/wangs278/scratch/fmi/run8_disease_out/logs/dryrun_%J.stderr
...
SCRIPT=/cv/home/wangs278/scratch/fmi/dryrun_run8_disease.py
