#!/bin/bash
#SBATCH -J onco_mlm_dx12
#SBATCH -o /cv/home/wangs278/scratch/fmi/run5_dx12_out/logs/train_%J.stdout
#SBATCH -e /cv/home/wangs278/scratch/fmi/run5_dx12_out/logs/train_%J.stderr
...
SCRIPT=/cv/home/wangs278/scratch/fmi/train_dx12.py
